...
print("Today d&T is:", current_date_time)
...
timestamp = datetime.date.fromtimestamp(1693796870)
print("Date =", timestamp)
# Calculating future dates 
# for one year 
future_date_after_1yr = current_date_time + datetime.timedelta(days = 365) 
#for 4 days and time
future_date_after_4days = current_date_time + datetime.timedelta(days = 4,hours = 5,
...
# for one years 
past_date_before_1yr = current_date_time - datetime.timedelta(days = 365) 

# for two hours 
past_date_before_2hours = current_date_time - datetime.timedelta(days=2,hours = 2) 


# printing calculated past_dates 
print('past_date_before_1yr:', past_date_before_1yr)
print('past_date_before_2days:', past_date_before_2hours)

# strftime function is used to convert the date time object as string
str_conv_date=current_date_time.strftime("%m/%a/%y")
...
print(random.randrange(100000,999999,2))
